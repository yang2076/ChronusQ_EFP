...
CQRESTEST_IMPL( Water_631Gd_BLYP_RESIDUE, SerialJob, 
  ...
  CQRESTEST_IMPL( Water_631Gd_BLYP_RESIDUE_GPLHR_DIRECT, SerialJob, 
  ...
  CQRESTEST_IMPL( PAR_Water_631Gd_BLYP_RESIDUE, ParallelJob, 
      "resp/parallel/rresp_ks/water_6-31Gd_rblyp_residue",
      "water_6-31Gd_rblyp_residue.bin.ref") 

  // SMP Water 6-31G(d) TDBLYP (RESIDUE, GPLHR + DIRECT)
  CQRESTEST_IMPL( PAR_Water_631Gd_BLYP_RESIDUE_GPLHR_DIRECT, ParallelJob, 
  ...
  CQRESTEST_IMPL( Water_631Gd_BLYP_RESIDUE_APB_AMB, SerialJob, 
    ...
    CQRESTEST_IMPL( PAR_Water_631Gd_BLYP_RESIDUE_APB_AMB, ParallelJob, 
  ...
  CQRESTEST_IMPL( Water_631Gd_BLYP_RESIDUE_RED, SerialJob, 
    ...
    CQRESTEST_IMPL( PAR_Water_631Gd_BLYP_RESIDUE_RED, ParallelJob, 
