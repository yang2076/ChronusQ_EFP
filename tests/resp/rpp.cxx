...
BOOST_AUTO_TEST_SUITE( RHF_PP_RESIDUE )
...
CQRESTEST_IMPL( BH_ccpVDZ_ppRPA_AA_RESIDUE, SerialJob, 
  ...
  CQRESTEST_IMPL( BH_ccpVDZ_ppRPA_AA_RESIDUE_GPLHR, SerialJob, 
      "resp/serial/rpp/BH_ccpVDZ_AA_ppRPA_gplhr",
      "BH_ccpVDZ_AA_ppRPA.bin.ref" )

  // BH cc-pVDZ PP-RPA-HF (AA) (RESIDUE, GPLHR + DIRECT)
  CQRESTEST_IMPL( BH_ccpVDZ_ppRPA_AA_RESIDUE_GPLHR_DIRECT, SerialJob, 
...
CQRESTEST_IMPL( BH_ccpVDZ_ppRPA_AB_RESIDUE, SerialJob, 
  ...
  CQRESTEST_IMPL( BH_ccpVDZ_ppRPA_AB_RESIDUE_GPLHR, SerialJob, 
      "resp/serial/rpp/BH_ccpVDZ_AB_ppRPA_gplhr",
      "BH_ccpVDZ_AB_ppRPA.bin.ref" )

  // BH cc-pVDZ PP-RPA-HF (AB) (RESIDUE, GPLHR + DIRECT)
  CQRESTEST_IMPL( BH_ccpVDZ_ppRPA_AB_RESIDUE_GPLHR_DIRECT, SerialJob, 
...
CQRESTEST_IMPL( BH_ccpVDZ_ppTDA_AA_RESIDUE, SerialJob, 
  ...
  CQRESTEST_IMPL( BH_ccpVDZ_ppTDA_AA_RESIDUE_GPLHR, SerialJob, 
      "resp/serial/rpp/BH_ccpVDZ_AA_ppTDA_gplhr",
      "BH_ccpVDZ_AA_ppTDA.bin.ref" )

  // BH cc-pVDZ PP-TDA-HF (AA) (RESIDUE, GPLHR + DIRECT)
  CQRESTEST_IMPL( BH_ccpVDZ_ppTDA_AA_RESIDUE_GPLHR_DIRECT, SerialJob, 
...
CQRESTEST_IMPL( BH_ccpVDZ_ppTDA_AB_RESIDUE, SerialJob, 
  ...
  CQRESTEST_IMPL( BH_ccpVDZ_ppTDA_AB_RESIDUE_GPLHR, SerialJob, 
      "resp/serial/rpp/BH_ccpVDZ_AB_ppTDA_gplhr",
      "BH_ccpVDZ_AB_ppTDA.bin.ref" )

  // BH cc-pVDZ PP-TDA-HF (AB) (RESIDUE, GPLHR + DIRECT)
  CQRESTEST_IMPL( BH_ccpVDZ_ppTDA_AB_RESIDUE_GPLHR_DIRECT, SerialJob, 
...
CQRESTEST_IMPL( BH_ccpVDZ_hhTDA_AA_RESIDUE, SerialJob, 
    "resp/serial/rpp/BH_ccpVDZ_AA_hhTDA",
    "BH_ccpVDZ_AA_hhTDA.bin.ref" )

// BH cc-pVDZ HH-TDA-HF (AB) (RESIDUE)
CQRESTEST_IMPL( BH_ccpVDZ_hhTDA_AB_RESIDUE, SerialJob, 
